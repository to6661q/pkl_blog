...
@endif
    ...
    <a href="{{ route('profilcategory.create')}}" class="btn btn-primary btn-sm" style="background-color:#134281">Tambah Kategori Postingan Profil</a>
    <br>
    <br>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('profilcategory.destroy', $hasil->id) }}" method="POST">
                        ...
                        @csrf
                        @method('delete')
                        <a href="{{ route('profilcategory.edit', $hasil->id) }}" class="btn btn-primary btn-sm" style="background-color:#134281">Edit</a>
